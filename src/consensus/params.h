...
struct Params {
    ...
    int FBTCZawyLWMAHeight;
    /** Block height at which Equihash<144,5> becomes active */
    int FBTCEquihashForkHeight;
    /** Limit BITCOIN_MAX_FUTURE_BLOCK_TIME **/
    int64_t FBTCMaxFutureBlockTime;
    /** Premining blocks for Bitcoin GPU hard fork **/
    int FBTCPremineWindow;
    bool FBTCPremineEnforceWhitelist;
    /**
    ...
    int64_t ZawyLwmaAdjustedWeight(int height) const {
        return (height >= FBTCEquihashForkHeight)
