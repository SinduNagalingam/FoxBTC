...
bool CheckEquihashSolution(const CBlockHeader *pblock, const CChainParams& params)
{
    ...
    EhInitialiseState(n, k, state, params.EquihashUseFBTCSalt(height));
