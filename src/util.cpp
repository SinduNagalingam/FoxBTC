...
const char * const BITCOIN_CONF_FILENAME = "foxbtc.conf";
const char * const BITCOIN_LEGACY_CONF_FILENAME = "bitcoin.conf";
const char * const BITCOIN_PID_FILENAME = "foxbtcd.pid";
...
{
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\foxbtc
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\foxbtc
    // Mac: ~/Library/Application Support/foxbtc
    // Unix: ~/.foxbtc
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "foxbtc";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/foxbtc";
#else
    // Unix
    return pathRet / ".foxbtc";
#endif
#endif
}
    ...
    if (streamConfig.good()) {
        {
            ...
            for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
                // Don't overwrite existing settings so command line settings override foxbtc.conf
